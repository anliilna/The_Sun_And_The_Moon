...
def main_menu():  # création de l'écran d'accueil
    while playing:
        ...
        MENU_TEXT = get_font(50).render("When The Sun",
                                        True,
                                        ((255, 211, 140)))
        MENU_TEXT0 = get_font(50).render("Loves The Moon",
                                         True,
                                         ((195, 221, 231)))
        ...
        OPTIONS_BUTTON = Button(image=None,
                                ...
                                base_color=((215, 252, 212)),
                                hovering_color=((255, 255, 255)))
        TOUCHES_BUTTON = Button(image=None,
                                pos=(600, 450),
                                text_input="TOUCHES",
                                font=get_font(50),
                                base_color=((215, 252, 212)),
        ...
        for button in [PLAY_BUTTON, OPTIONS_BUTTON, QUIT_BUTTON, TOUCHES_BUTTON]:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if OPTIONS_BUTTON.checkForInput(MENU_MOUSE_POS):
                    options()
                if TOUCHES_BUTTON.checkForInput(MENU_MOUSE_POS):
